...
from datasets.fsns_dataset import FileBasedFSNSDataset
...
if __name__ == "__main__":
    ...
    parser.add_argument("--is-original-fsns", action='store_true', default=False,
                        help='indicates that the dataset used contains original fsns data')
    ...
    target_shape = Size(width=100, height=32)
    ...
    # attributes_to_adjust = [
    #     ('num_timesteps', ['predictor']),
    #     ('num_timesteps', ['lossfun', '__self__']),
    #     ('num_labels', ['predictor']),
    # ]

    curriculum = BabyStepCurriculum(
        args.dataset_specification,
        FileBasedFSNSDataset,
        args.blank_label,
    ...
    recognition_net = FSNSSoftmaxRecognitionResNet(
        target_shape,
